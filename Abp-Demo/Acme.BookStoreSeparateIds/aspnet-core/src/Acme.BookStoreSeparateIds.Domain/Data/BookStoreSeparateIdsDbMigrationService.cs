...
{
    public class BookStoreSeparateIdsDbMigrationService : ITransientDependency
    {
        public ILogger<BookStoreSeparateIdsDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IBookStoreSeparateIdsDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public BookStoreSeparateIdsDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IBookStoreSeparateIdsDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<BookStoreSeparateIdsDbMigrationService>.Instance;
        }
