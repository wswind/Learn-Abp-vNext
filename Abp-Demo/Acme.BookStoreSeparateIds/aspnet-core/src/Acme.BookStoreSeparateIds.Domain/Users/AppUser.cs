...
namespace Acme.BookStoreSeparateIds.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update BookStoreSeparateIdsDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BookStoreSeparateIdsEfCoreEntityExtensionMappings to extend the IdentityUser entity
