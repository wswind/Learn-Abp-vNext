...
namespace LearnAbp.ObjectExtending
{
    public static class LearnAbpDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the LearnAbpEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
