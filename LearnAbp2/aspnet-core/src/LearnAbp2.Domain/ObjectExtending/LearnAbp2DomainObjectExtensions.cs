...
namespace LearnAbp2.ObjectExtending
{
    public static class LearnAbp2DomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the LearnAbp2EfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
